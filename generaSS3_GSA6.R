...
data_path <- "datos_GSA6_SS3.xlsx" # data in SS3 format

#'*###############################################################################*
# DATA FILE ----
#'*###############################################################################*

inputs$dat$Comments <- sprintf("#C %s model generated by GSA6", mod_path)

## General specification ----
inputs$dat$styr<-2002
